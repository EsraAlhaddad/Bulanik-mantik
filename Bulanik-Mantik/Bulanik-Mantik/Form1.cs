...
namespace Bulanik_Kurallari
{
    ...
    {
        BulanikMantik core = new BulanikMantik();
        public Form1()
        {
            InitializeComponent();
            CustomInitialize();
        ...
        public void CustomInitialize()
        {
            ...
            for (int i = 0; i < 8; i++)   
                flowLayoutPanel1.Controls.Add(new Kurallar() { Visible = false });
        ...
        public void Hesapla()
        {
            ...
            foreach (var list1 in core.KesisimList[0])
            {
                foreach (var list2 in core.KesisimList[1])
                {
                    foreach (var list3 in core.KesisimList[2])
                    {
                        ...
                        Kurallar kuralComp = flowLayoutPanel1.Controls[componentCounter++] as Kurallar;
            ...
            var count = flowLayoutPanel1.Controls.OfType<Kurallar>().Where(a => a.Visible == true).Count();
        ...
        private void trackBar2_Scroll(object sender, EventArgs e)
        {
            ...
            string lineStr =(core.KesisimHesapla(temp, (BulanikMantik.KESISIM)(indis - 1)).Min().ToString());
