       ...
       public class Kural
    {
        ...
        public double[] GetKesisimX
        {
            get
            {
                ...
                list.Add(core.KesisimHesapla(x1, BulanikMantik.KESISIM.HASSASLIK, (int)Hassaslık).Single());
                list.Add(core.KesisimHesapla(x2, BulanikMantik.KESISIM.MIKTAR, (int)Miktar).Single());
                list.Add(core.KesisimHesapla(x3, BulanikMantik.KESISIM.KIRLILIK, (int)Kirlilik).Single());
                return list.ToArray();
            }
        }
